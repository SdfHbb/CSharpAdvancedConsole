...
namespace cSharpAdvancedConsole._04._15
{
  public class Mage : Entity
  {
    ...
    public Mage(string name, int lifePoint) : base(name, lifePoint)
    {
    }
    ...
    public override void NormalAttack(Entity entity)
    {
      ...
      Console.WriteLine($"\n{this.name} uses Scorche und causes {damage} Damage on {entity.name}");
    ...
    public override void SpecialAttack(Entity entity)
    {
      ...
      Console.WriteLine($"\n{this.name} uses Pyroblast und causes {damage} Damage on {entity.name}");
      Console.WriteLine($"{entity.name} Lifepoints: {entity.lifePoint - damage}\n");
    }
  }
}